...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.false_button = Button(image=false_image, highlightthickness=0, command=self.true_press)
        self.false_button.grid(row=2, column=1)

        true_image = PhotoImage(file="images/true.png")
        self.true_button = Button(image=true_image, highlightthickness=0, command=self.false_press)
